...
PLATFORM=VC-WIN32
CC=cl
CFLAG= /MDd /W3 /G5 /Ox /O2 /Ob2 /Gs0 /GF /Gy /nologo -DWIN32 -DWIN32_LEAN_AND_MEAN -DL_ENDIAN -DDSO_WIN32 /Fdout32
APP_CFLAG=
LIB_CFLAG=
SHLIB_CFLAG=
...
HEADER=$(INCL_D)\cryptlib.h \
	$(INCL_D)\buildinf.h $(INCL_D)\md32_common.h $(INCL_D)\md4_locl.h \
	...
	$(INCL_D)\bss_file.c $(INCL_D)\obj_dat.h $(INCL_D)\conf_def.h \
...
EXHEADER=$(INCO_D)\e_os.h \
	...
	$(INCO_D)\asn1.h $(INCO_D)\asn1_mac.h $(INCO_D)\pem.h \
	$(INCO_D)\pem2.h $(INCO_D)\x509.h $(INCO_D)\x509_vfy.h \
	$(INCO_D)\x509v3.h $(INCO_D)\conf.h $(INCO_D)\conf_api.h \
	$(INCO_D)\txt_db.h $(INCO_D)\pkcs7.h $(INCO_D)\pkcs12.h \
	$(INCO_D)\comp.h $(INCO_D)\ssl.h $(INCO_D)\ssl2.h \
...
E_OBJ=$(OBJ_D)\verify.obj \
	...
	$(OBJ_D)\rand.obj $(OBJ_D)\openssl.obj
...
CRYPTOOBJ=$(OBJ_D)\cryptlib.obj \
	...
	$(OBJ_D)\fcrypt_b.obj $(OBJ_D)\read2pwd.obj $(OBJ_D)\fcrypt.obj \
	$(OBJ_D)\xcbc_enc.obj $(OBJ_D)\read_pwd.obj $(OBJ_D)\rpc_enc.obj \
	$(OBJ_D)\cbc_cksm.obj $(OBJ_D)\ede_cbcm_enc.obj $(OBJ_D)\rc2_ecb.obj \
	...
	$(OBJ_D)\bn_ctx.obj $(OBJ_D)\bn_mul.obj $(OBJ_D)\bn_print.obj \
	...
	$(OBJ_D)\rsa_null.obj $(OBJ_D)\dsa_gen.obj $(OBJ_D)\dsa_key.obj \
	...
	$(OBJ_D)\dso_win32.obj $(OBJ_D)\dso_vms.obj $(OBJ_D)\dh_gen.obj \
	...
	$(OBJ_D)\evp_enc.obj $(OBJ_D)\evp_key.obj $(OBJ_D)\e_des.obj \
	...
	$(OBJ_D)\p5_crpt2.obj $(OBJ_D)\a_object.obj $(OBJ_D)\a_bitstr.obj \
	$(OBJ_D)\a_utctm.obj $(OBJ_D)\a_gentm.obj $(OBJ_D)\a_time.obj \
	$(OBJ_D)\a_int.obj $(OBJ_D)\a_octet.obj $(OBJ_D)\a_null.obj \
